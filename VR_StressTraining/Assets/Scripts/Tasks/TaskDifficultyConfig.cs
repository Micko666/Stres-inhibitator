...
namespace StressTraining.Tasks
{
    ...
    public sealed class TaskLevelParameters
    {
        ...
        /// <summary>
        /// Purely visual distractor rows drawn above and below the relevant row.
        /// 0 = the single classic row, 2 = one above and one below. Never 1: with an
        /// odd number of rows the relevant row stays the middle one, which is what
        /// makes "the centre arrow of the middle row" an unambiguous instruction.
        /// They carry no expected response and no congruency. PROJECT_HEURISTIC.
        /// </summary>
        public int flankerDistractorRows;
        /// <summary>
        /// Share of distractor cells drawn as a directional arrow instead of a
        /// neutral dash — how crowded the irrelevant rows look. Relevant only when
        /// <see cref="flankerDistractorRows"/> &gt; 0. PROJECT_HEURISTIC.
        /// </summary>
        public double flankerDistractorDensity;
        ...
        private static TaskLevelParameters Flanker(int level)
        {
            ...
            switch (level)
            {
                case 1:
                    ...
                    p.interTrialIntervalSeconds = 1.0;
                    p.flankerDistractorRows = 0; p.flankerDistractorDensity = 0.0;
                    break;
                case 2:
                    ...
                    p.flankerDistractorRows = 2; p.flankerDistractorDensity = 0.55;
                    break;
                default:
                    ...
                    p.flankerDistractorRows = 2; p.flankerDistractorDensity = 1.0;
                    break;
            }
            return p;
        }

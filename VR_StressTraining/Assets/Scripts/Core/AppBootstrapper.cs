...
namespace StressTraining.Core
{
    ...
    public sealed class AppBootstrapper : MonoBehaviour
    {
        ...
        private void InitializeRuntime()
        {
            ...
            _coordinator.Boot();
            _initialized = true;
            // One pass, after everything is built: names the object that renders
            // magenta in a build, which cannot be seen from the Editor.
            FlowTrace.ReportMagentaRenderers();

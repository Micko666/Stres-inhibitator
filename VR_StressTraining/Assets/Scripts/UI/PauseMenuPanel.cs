...
namespace StressTraining.UI
{
    public sealed class PauseMenuPanel : MenuPanelBase
    {
        ...
        {
            ("Hoću da prekinem", UserTerminationReason.UserRequested),
        ...
        public void ShowMain()
        {
            ...
            SetInfo("Uperi zrak u dugme i pritisni okidač · Y na lijevom kontroleru nastavlja");
        ...
        private void ShowReasons()
        {
            ...
            SetBody("Izaberi razlog prekida. Sve što je do sada snimljeno ostaje sačuvano.");

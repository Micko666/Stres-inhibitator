    ...
    public sealed class BreathingPanel : MenuPanelBase
    {
        ...
        public void Begin(BreathingGuidanceConfig cfg, bool firstSessionOfCycle)
        {
            ...
            SetBody(firstSessionOfCycle
                ? "Ubrzan puls i napetost pod pritiskom su normalna reakcija tijela. " +
                  "Mirno disanje, bez forsiranja, i pažnja usmjerena na naredni korak pomažu da zadržiš pribranost.\n" +
                  "Prati krug — širi se dok udišeš, skuplja dok izdišeš."
                : "Kratak podsjetnik: mirno disanje, pažnja na naredni korak.");
            ...
            bool firstSessionOfCycle)
        {
            ...
            SetTitle("Priprema 1 od 2 — vođeno disanje i mjerenje pulsa");
            SetBody(firstSessionOfCycle
                ? "Prati krug — širi se dok udišeš, skuplja dok izdišeš.\n" +
                  "U isto vrijeme mjerimo tvoj polazni puls za ovu sesiju."
                : "Prati ritam disanja. U isto vrijeme mjerimo polazni puls za ovu sesiju.");

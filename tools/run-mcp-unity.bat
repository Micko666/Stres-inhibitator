...
rem Wrapper that sets cwd to VR_StressTraining and forces 60s timeout
...
rem reads this env var first (before the config file), so timeout is always 60s
...
set MCPUNITY_REQUEST_TIMEOUT_SECONDS=60
